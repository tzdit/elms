...
//         exit;
    ...
    public function actionCourseAnnouncement($cid){
        ...
        $reg_no = Yii::$app->user->identity->username;
        $yearid=yii::$app->session->get('currentAcademicYear')->yearID;
        $announcement = Announcement::find()->where(['course_code' => $cid,'yearID'=>$yearid])->orderBy([
            'annID' => SORT_DESC ])->all();
    ...
    public function actionCourses(){
       ...
       $courses = Course::find()->select('course.course_code, course.course_credit, course.course_status ')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => $yos])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();
       $courses1 = Course::find()->select('course.course_code, course.course_credit, course.course_status, course.course_semester, course.course_name')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => 1])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();
       $courses2 = Course::find()->select('course.course_code, course.course_credit, course.course_status, course.course_semester, course.course_name')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => 2])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();
       $courses3 = Course::find()->select('course.course_code, course.course_credit, course.course_status, course.course_semester, course.course_name')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => 3])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();
       $courses4 = Course::find()->select('course.course_code, course.course_credit, course.course_status, course.course_semester, course.course_name')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => 4])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();
       $courses5 = Course::find()->select('course.course_code, course.course_credit, course.course_status, course.course_semester, course.course_name')->rightJoin('program_course','program_course.course_code = course.course_code')->where('program_course.programCode = :program_code AND program_course.level = :YOS',[':program_code' => $student_regno->programCode, ':YOS' => 5])->orderBy(['program_course.PC_ID' => SORT_ASC])->all();

            return $this->render('courses', ['data'=>$courses, 'courses1'=>$courses1, 'courses2'=>$courses2, 'courses3'=>$courses3, 'courses4'=>$courses4, 'courses5'=>$courses5 ]);
    }
    ...
    public function actionViewNormalAssignments($cid)
    {
        ...
        $reg_no = Yii::$app->user->identity->username;
        $yearid=yii::$app->session->get('currentAcademicYear')->yearID;
        $assignments = Assignment::find()->where('assNature = :assignment AND course_code = :cid AND (assType = :students OR assType = :allstudent) AND yearID=:yearid',[':assignment' => 'assignment', ':cid' => $cid,':yearid'=>$yearid, ':students' => 'students', ':allstudent' => 'allstudents'])->orderBy([
            'assID' => SORT_DESC ])->all();
