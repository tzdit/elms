...
<div class="modal-dialog" role="document">
    <div class="modal-content modal-lg">
      <div class="modal-header bg-primary p-1">
        <span class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Update Module</span>
  ...
  <div class="row">
      ...
      <br/>
        ...
        <div class="row">
        <div class="col-md-12">
        <?= Html::submitButton('<i class="fa fa-edit"></i> Update', ['class'=>'btn btn-primary float-right ml-2']) ?>
