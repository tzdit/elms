...
?>
      ...
      <div class="row">
        ...
        <?php if($groups==null){?>
          <div class="container p-5 mt-3 text-center border">
               <i class='fa fa-info-circle'></i> No Group Generations Found
               </div>
          <?php } ?>
...
<div class="accordion" id="accordionExample">
  <div class="card" >
    <div class="card-header p-2" id="heading">
      ...
      <button class="btn btn-link btn-block text-left text-info col-md-11" type="button" >
        <i class="fas fa-clipboard-list text-info"></i> <?=Html::encode($group->generation_type);?>
        </button>
      </div>
      ...
      <div class="col-sm-1">
      <a href="#" ccode=<?=$group->typeID;?> class="grpdelete"><button  class="float-right btn btn-link text-info"><span><i class="fas fa-trash" style="font-size:17px"></i></span></button></a>
      </div>
