  ...
  <div class="card" >
    <div class="card-header p-2" id="heading">
      ...
      <button class="btn btn-link btn-block text-left col-md-11" type="button" >
        <i class="fas fa-clipboard-list"></i> <?php print $group->generation_type;?>
        </button>
      </div>
      ...
      <span style="font-size:12px; color:#ccc">Generated by <?php print $group->instructor->full_name; ?></span>
      </div>
      <div class="col-sm-1">
      ...
      <div class="card-body">
         <div class="card-footer p-0">
                <?php for($g=0;$g<count($group->groups);$g++){?>
                  ...
                  <div class="card-header p-2" id="grouphead">
                  ...
                  <div class="col-sm-5"><?php print $group->groups[$g]->studentGroups[$st]->regNo->fname." ".$group->groups[$g]->studentGroups[$st]->regNo->mname." ".$group->groups[$g]->studentGroups[$st]->regNo->lname; ?></div>
                  <div class="col-sm-4"><?php print $group->groups[$g]->studentGroups[$st]->regNo->reg_no; ?></div>
                  <div class="col-sm-1"><?php print $group->groups[$g]->studentGroups[$st]->regNo->programCode; ?></div>
                  <div class="col-sm-1"><?php print $group->groups[$g]->studentGroups[$st]->regNo->YOS; ?></div>
                  </div>
                  <?php } ?>
                  </div>
                  </div>
