...
$this->params['courseTitle']="<i class='fa fa-plus-circle'></i> Add Students";
?>
    ...
    <div class="body-content">
        ...
        <div class="container-fluid">
           ...
           <div class="row"><div class="col-md-12">
                  ...
                  <?= Html::a('<i class="fas fa-download" ></i>Download template', ['download-stdexcell-template'],['class'=>'btn btn-sm btn-primary btn-rounded float-right mb-2']) ?>
</div></div>
