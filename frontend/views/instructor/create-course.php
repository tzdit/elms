...
$this->params['courseTitle']="<i class='fa fa-book'></i> Modules List";
?>
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="row">
        <div class="col-md-12">
        <?= Html::submitButton('<i class="fa fa-plus-circle"></i> Submit', ['class'=>'btn btn-primary btn-md float-right ml-2']) ?>
 ...
 <div class="row">
          ...
          <section class="col-lg-12">
            ...
            <table class="table table-bordered table-striped table-hover" id="CourseList" style="width:100%; font-family:'Time New Roman'; font-size:14px;">
              <a href="#" class="btn btn-sm btn-primary btn-rounded float-right m-0 col-xs-12" data-target="#createCourseModal" data-toggle="modal"><i class="fas fa-plus" ></i> Add Module</a>
            <thead>
            ...
            <td>
                ...
                <?= Html::a('<i class="fas fa-eye inner" data-toggle="tooltip" data-title="Module Profile"></i>',['view-coz', 'cid'=>$course->course_code], ['class'=>' ml-1'])?>
                <?= Html::a('<i class="fas fa-edit"></i>',['updatecoz', 'cozzid'=>$course->course_code], ['class'=>'mr-1'])?>
