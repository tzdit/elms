               ...
               <div class="col-md-12">
                  ...
                  <td>
                    <?php if(Custom::isEnrolled($course->course_code)): ?>
                      ...
                      <?php else:?>
                  <a href="#" class="btn btn-sm btn-info enroll" data-toggle="modal" data-target="#EnrollModal" ccode="<?= $course->course_code ?>" cname="<?= $course->course_name ?>"><i class="fa fa-plus-circle" data-toggle="tooltip" data-title="Take this course"></i></a>
                 <?php endif ?>
                  </td>
                  </tr>
                  <?php endforeach ?>
