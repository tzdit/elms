...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <section class="col-md-12">
              ...
              <p class="text-secondary mb-1">Add Single User</p>
              <?php $form = ActiveForm::begin()?>
                 ...
                 <div class="row"> 
                 <div class="col-md-12">
                   <?= $form->field($model, 'college')->dropdownList($colleges, ['prompt'=>'--Select--', 'class'=>['form-control form-control-sm']], )->label(' College') ?>
                  </div>
                 ...
                 <div class="col-md-12">
                   ...
                   <?= $form->field($model, 'role')->dropdownList($roles, ['options'=>['SYS_ADMIN'=>['selected'=>true]], 'class'=>['form-control form-control-sm']], )->label('Role') ?>
              ...
              <div class="col-md-7">
              <p class="text-secondary">Upload Users using excel sheet</p>
             <form action="">
