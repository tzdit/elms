...
<div class="modal fade" id="adminmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     <div class="modal-header  pl-4 p-2 bg-info"><div class="modal-title ml-1"><i class='fa fa-plus-circle'></i> Add New Admin</div></div>
                 ...
                 <div class="col-md-12">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                     ...
                     <?= Html::submitButton('<i class="fa fa-save"></i> Save', ['class'=>'btn btn-default btn-md float-right bg-info mr-0']) ?>
