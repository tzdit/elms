...
<div class="modal fade" id="instructormodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     <div class="modal-header text-info pl-4"><div class="modal-title ml-1"><i class='fa fa-plus-circle'></i> Register Instructor</div></div>
                 ...
                 <div class="col-sm-6">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                     ...
                     <?= Html::submitButton('<i class="fa fa-save"></i> Save', ['class'=>'btn btn-default btn-md float-right mr-0 text-info']) ?>
