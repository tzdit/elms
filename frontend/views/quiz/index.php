...
$this->params['courseTitle'] ="<i class='fa fa-pen'></i> Quizes";
$this->title = 'Quizes';
                                                                    ...
                                                                    <div class="card shadow " style="width:91%">
                                                                        ...
                                                                        <div id="collapse<?=$quiz->quizID?>" class="collapse" aria-labelledby="heading<?=$quiz->quizID?>" data-parent="#accordion">
                                                                          ...
                                                                          <div class="row p-3 d-flex justify-content-center border p-0" style="font-size:11px">
                                                                              ...
                                                                              <div class="col-sm-2 p-0 "><span class="text-bold"><i class="far fa-calendar-check"></i> Started on </span><br><?=$quiz->start_time?></div>
                                                                              ...
                                                                              {
                                                                              ?>
                                                                              <div class="col-sm-2 p-0 "><span class="text-bold"><i class="far fa-calendar-minus"></i> Ended on </span><br><?=$quiz->end_time?></div>
                                                                              <?php
                                                                              }
                                                                              ?>
