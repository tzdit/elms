        ...
        <div class="container-fluid">
           <div class="card shadow card outline">
              <div class="card-body p-3 pr-1 text-center">
               ...
               <a href="#" class="text-info" data-toggle="modal" data-target="#questionmodal"><i class="fa fa-plus-circle"></i> New Question</a>
              ...
              <div class="card-body p-2 pl-1 text-right">
                <?php $bankfile=(new QuizManager)->getBankHome()?>
               <a href="#" class="btn btn-default shadow text-info" data-toggle="modal" data-target="#uploadermodal" ><i class="fa fa-upload" data-toggle="tooltip" data-title="Upload Questions Bank File" ></i></a>
               <a href="/<?=$bankfile?>" class="btn btn-default shadow text-info" data-toggle="tooltip" data-title="Download Questions Bank File"  ><i class="fa fa-download"></i></a>
               <a href="<?=Url::to("/quiz/download-bank")?>" class="btn btn-default shadow text-info" data-toggle="tooltip" data-title="Download As PDF"  ><i class="fa fa-file-pdf-o text-danger"></i></a>
               </div></div></div></div></div>
         
        
               <div class="container-fluid d-flex justify-content-center p-5 card card-outline card-info shadow">
               ...
               ?>
                 ...
                 <span class="text-center text-muted text-lg"><i class="fa fa-info-circle text-warning"></i> Questions Bank Empty !</span></div>
               <?php
                }
               ?>
               </div>
