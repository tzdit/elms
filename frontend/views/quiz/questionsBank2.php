        ...
        <div class="container-fluid">
           <div class="card shadow">
              <div class="card-body p-2 text-center">
               ...
               <a href="<?=Url::to("/quiz/questions-bank")?>"><i class="fa fa-bank"></i> Questions Bank</a>
               </div>
                   ...
                   ?>
                    <div class="row border-bottom" id=<?=$index?>>
                     ...
                     <div class="responsivetext col-sm-12">
                      ...
                      ?>
                      <input type="checkbox" name="quizQuestions[]" class="float-right mb-2 chooseq" value=<?=$index?>></input>
                     </div>
                 </div>
