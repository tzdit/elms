          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <a href="<?= Url::toRoute('/hod/create-student') ?>" class="btn btn-primary btn-sm float-right m-0 col-xs-12"><i class="fas fa-user-plus"></i> Create User</a>
            ...
            <thead>
            <tr><th width="1%">#</th><th>Full Name</th><th>Reg#</th><th>YOS</th><th>Department</th><th>College</th><th width="15%">Action</th></tr>
