            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills p-2">
                  <li class="nav-item"  ><a class="nav-link active" href="#tab_1" data-toggle="tab"><i class="fas fa-user"></i> Individual Labs </a></li>
                  <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab"><i class="fas fa-users"></i>Group Labs </a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
