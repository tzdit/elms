                    ...
                    <div class="card-body p-0 pl-1">
                        ...
                        <div class="row container-fluid ">
                            <div class="col-sm-3 col-12 ">
                                <a href="<?=Url::to(['student/view-normal-assignments/', 'cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 row result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                    ...
                                    <img src="<?=  Yii::getAlias('@web/img/Assignment4.png')?>" height="34px"
                                        width="38px" />
                                    <h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/student-group/', 'cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <img src="<?=  Yii::getAlias('@web/img/groupass.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        Group Assignments
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/tutorial/', 'cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <img src="<?=  Yii::getAlias('@web/img/tutorials.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        Tutorials
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['videos-and-notes/modules/', 'cid' => ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <img src="<?=  Yii::getAlias('@web/img/classmaterial.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        Course Materials
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/returned/', 'cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <img src="<?=  Yii::getAlias('@web/img/submitted 3.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        My submitted
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/course-announcement/', 'cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <img src="<?=  Yii::getAlias('@web/img/announcement.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        Announcements
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?= Url::toRoute('/quiz/student-quizes')  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                            ...
                            <div class="col-sm-3 col-12">
                                <a href="<?=Url::to(['forum/index', 'cid'=>ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/classmates'])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <img src="<?=  Yii::getAlias('@web/img/student.png')?>" height="35px"
                                        width="35px" />
                                    <h5>
                                        Classmates
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                <a href="<?=Url::to(['student/group-management-view/','cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student-lectureroom/lectures/','cid'=> ClassRoomSecurity::encrypt($cid)])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                  ...
                                  ?>
                                    <img src="<?=  Yii::getAlias('@web/img/school 2.png')?>" height="37px"
                                        width="40px" />
                                    <h5>
                                        Lecture Room
                                    </h5>
                            ...
                            <div class="col-sm-3 col-12">
                                ...
                                <a href="<?=Url::to(['student/externals/'])  ?>"
                                    class="card pl-2 pr-1  py-2 result-card mx-1 my-2 card-outline card-info">
                                    <?php
                                  ...
                                  ?>
                                    <img src="<?=  Yii::getAlias('@web/img/external.png')?>" height="37px"
                                        width="40px" />
                                    <h5>
                        ...
                        <?//= Url::toRoute(['student/quiz_answer'])?>
                        <!--"><i class="fa fa-pencil"></i> Take Quiz</a>-->
                        <!---->
                        <!--                                        <a class="btn btn-sm btn-outline-primary" href="-->
                        <?//= Url::toRoute(['student/quiz_view'])?>
