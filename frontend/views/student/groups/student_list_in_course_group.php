...
$this->title = Yii::t('app', 'Add student to a group');
 ...
 <div class="row">
          ...
          <section class="col-lg-12">
            ...
            <?php foreach($data as $student): ?>
                ...
                <?= $form->field($model, 'reg_no')->hiddenInput(['value'=>$student->reg_no])->label(false); ?>
                <?= $form->field($model, 'groupID')->hiddenInput(['value'=>$group_name->groupID])->label(false); ?>

                    <div class="form-group">
                        <?= Html::submitButton(Yii::t('app', ''), ['class' => 'fas fa-plus-square btn btn-primary']) ?>
                    </div>
                <?php ActiveForm::end(); ?>
