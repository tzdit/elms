                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                ...
                                                                                                <?php if($group->isCreator($regno)): ?>
                                                                                                    ...
                                                                                                    <?php else: ?>
                                                                                                        <h5 class="text-info" data-toggle="tooltip" data-title="Exit group"><a href="#" class="exitgroup float-right mr-2 mt-3" groupID = "<?= $item['groupID'] ?>" ><i class="fa fa-sign-out-alt fa-lg "></i></a></h5>
                                                                                                <?php endif; ?>
                                                                                                 </div>
                                                                                        </div>
                                                                                    </h2>
                                                                                        ...
                                                                                        <button class="btn btn-link btn-block text-left col-md-11" type="button" >
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-4 responsivetext">
                                                                                                    ...
                                                                                                    <h4 class="btn btn-default btn-sm shadow d-none d-md-block text-info" data-toggle="collapse" data-target="#collapse<?=$noGroupAssignmentCount?>" aria-expanded="true" aria-controls="collapse<?=$noGroupAssignmentCount?>"><i class="fa fa-plus-circle"></i>Create Group</h4>
                                                                                                </div>
                                                                                            </div>
                                                                    ...
                                                                    <div id="collapse<?=$noGroupAssignmentCount?>" class="collapse" aria-labelledby="heading<?=$noGroupAssignmentCount?>" data-parent="#accordionExample_33">
                                                                        ...
                                                                        <div class="card mx-3 p-4  form-group">
                                                                            ...
                                                                            <div class="mb-2 text-center">
                                                                                <h5 class="text-info text-sm responsivetext"><i class="fa fa-info-circle"></i> You will automatically be added to the group you create</h5>
                                                                            </div>
                                                                            <div class="container pl-5 pr-5 text-sm text-info">
                                                                            <?php 
