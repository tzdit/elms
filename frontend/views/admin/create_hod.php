...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <section class="col-md-12">
              ...
              <p class="text-secondary mb-1">Add Single Hod</p>
              <?php $form = ActiveForm::begin()?>
                 ...
                 <div class="col-md-6">
                   ...
                   <?= $form->field($model, 'role')->dropdownList($roles, ['options'=>['HOD'=>['selected'=>true]], 'class'=>['form-control form-control-sm']], )->label('Role') ?>
              ...
              <div class="col-md-7">
              <p class="text-secondary">Upload Hods using excel sheet</p>
             <form action="">
