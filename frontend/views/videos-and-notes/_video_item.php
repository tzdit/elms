...
<div class="card m-3" style="width: 20rem;">
    ...
    <div class="card-body p-2">
        ...
        <div class='row card-text'>
            ...
            <div class="col-sm-6">
                <a href="<?= Url::toRoute(['/videos-and-notes/download_video_and_notes','material_ID'=> ClassRoomSecurity::encrypt($model->material_ID)])?>" class="card-text float-right mt-0"><span><i class="fas fa-download fa-2x"></i></span></a>
            </div>
        </div>
