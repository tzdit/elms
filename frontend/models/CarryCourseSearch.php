...
/**
 * CarryCourseSearch represents the model behind the search form of `common\models\Course`.
 */
class CarryCourseSearch extends Course
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['course_code', 'course_name', 'course_status'], 'safe'],
