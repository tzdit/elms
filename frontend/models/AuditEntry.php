...
class AuditEntry extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['audit_entry_timestamp', 'audit_entry_model_name', 'audit_entry_operation', 'audit_entry_field_name', 'audit_entry_old_value', 'audit_entry_new_value', 'audit_entry_user_id', 'audit_entry_ip','audit_entry_affected_record_reference','audit_entry_affected_record_reference_type'], 'required'],
            [['audit_entry_old_value','audit_entry_affected_record_reference', 'audit_entry_new_value'], 'string'],
            [['audit_entry_affected_record_reference'],'max' => 30],
            [['audit_entry_affected_record_reference_type'],'max' => 30],
